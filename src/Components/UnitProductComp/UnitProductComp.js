        ...
        <div className="unitProd">
          ...
          <span className="productImage" >  
            ...
            <span>
                ...
                {props.props.weight!=0 && <p className="weight">{`(${props.props.weight} ${props.props.weight_unit})`}</p>}
                <span className="prices">
                    <p className="final_price">{`₹ ${props.props.final_price}`}</p>
                   
                    <p className="price">{`₹ ${props.props.price}`}</p>
                </span>
                {(props.props.is_in_stock && <button className="button1">ADD TO CART</button>) || <button className="button2" disabled>OUT OF STOCK</button>}
            </span>
